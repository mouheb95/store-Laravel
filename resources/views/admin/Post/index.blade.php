                ...
                <div class="card card-box mb-5">
                    ...
                    <table id="example" class="table table-hover w-100" data-toggle="datatable">
                        ...
                        <tr>
                            ...
                            @if($post->verified == 1)
                                <td> <a href="{{route('verified', [$post , $post->verified])}}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Refresh"> verified </a> </td>
                             @else 
                                <td> <a href="{{route('verified', [$post , $post->verified])}}" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Refresh"> not verified </a> </td>                            
                            @endif
                            

                            <td class="text-center text-nowrap">
                                <a href="{{route('post.edit', $post->id)}}" class="btn btn-first pl-2 pr-2 btn-sm ml-1 mr-1" title="View details">
                                    E
                                </a>
